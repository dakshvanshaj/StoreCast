...
def execute_contextual_anomaly_hunting() -> None:
    ...
    business_view.write_csv(config.ANOMALIES_PATH)
    
    logger.info("Anomaly hunting protocol achieved!", anomalies_found=len(anomalies), path=str(config.ANOMALIES_PATH))
